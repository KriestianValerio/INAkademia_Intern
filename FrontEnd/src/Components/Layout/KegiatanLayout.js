        ...
        <div>
            ...
            <div className='container mx-auto mt-28'>
                ...
                <div className='font-medium sm:px-2'>
                    ...
                    <button onClick={ () => navigate(-1) } className="text-white bg-red-700 hover:bg-red-800 focus:outline-none font-medium rounded-full text-sm sm:text-base md:text-lg lg:text-xl px-5 py-2.5 text-center sm:-mr-8 lg:mr-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700">
                        Kembali
                    </button>
                    {props.dir && 
                    <Link to={props.dir} className="text-white bg-red-700 hover:bg-red-800 focus:outline-none font-medium rounded-full text-sm sm:text-base md:text-lg lg:text-xl px-5 py-2.5 text-center sm:-mr-8 lg:mr-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 ">
                        Artikel berikutnya
                    </Link>
                    }
                    </div>
